...
Q_CONSTINIT static const qt_meta_stringdata_QwtLegendLabel_t qt_meta_stringdata_QwtLegendLabel = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QwtLegendLabel[] = {
